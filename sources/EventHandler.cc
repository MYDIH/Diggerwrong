...
int EventHandler::call(sf::RenderWindow & w, sf::Event & e)
{
    ...
    case sf::Event::MouseButtonPressed:
        return mouse_button_pressed(w, e.MouseButton);
    case sf::Event::MouseButtonReleased:
        return mouse_button_released(w, e.MouseButton);
    case sf::Event::KeyPressed:
        return key_pressed(w, e.Key);
    case sf::Event::KeyReleased:
        return key_released(w, e.Key);
    case sf::Event::Resized:
        return resized(w, e.Size);
    case sf::Event::MouseMoved:
        return mouse_moved(w, e.MouseMove);
